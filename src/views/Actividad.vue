  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Hecho económico y la contabilidad organizacional
        p.mb-4 Establecer una relación precisa entre los conceptos esenciales del hecho económico y los procedimientos contables aplicados en las organizaciones.
